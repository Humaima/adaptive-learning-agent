...
ACCESS_TOKEN_EXPIRE_MINUTES = 15  # was 60*24 — now short-lived by design


FLASHCARD_INITIAL_INTERVAL_DAYS = 1
FLASHCARD_EASE_MULTIPLIER = 2.0
NUM_FLASHCARDS_PER_CONCEPT = 5